...
export const homepageFaqs = [
  {
    q: "What does the AlfredWorks copilot do?",
    a: "Alfred is the contract intelligence copilot in AlfredWorks. It reads construction tenders and contracts, surfaces hidden risks, tracks obligations against project schedules, and drafts EOT and claim notices. A human always reviews and approves every action: Alfred never auto-sends."
  },
  {
    q: "What contract standards does the AlfredWorks copilot read?",
  ...
  {
    q: "Does the AlfredWorks copilot send letters or notices automatically?",
  ...
  {
    q: "How is the AlfredWorks copilot different from a project management tool like Procore?",
  ...
  {
    q: "Who uses the AlfredWorks copilot?",
  ...
  {
    q: "How does the AlfredWorks copilot connect to our existing systems?",
