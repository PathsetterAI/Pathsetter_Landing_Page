      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left w-full h-full justify-center md:border-r border-border md:pr-12 md:py-4">
