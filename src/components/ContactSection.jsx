        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left w-full h-full justify-center md:border-r border-white/10 md:pr-12 md:py-4">
            ...
            <button
              ...
              className="bg-accent text-primary-bg px-6 py-2.5 rounded-lg font-bold uppercase tracking-widest text-xs hover:bg-accent-hover transition-all shadow-[0_0_20px_rgba(0,191,153,0.3)] hover:shadow-[0_0_30px_rgba(0,191,153,0.5)] transform hover:-translate-y-1 w-full sm:w-[200px] flex items-center justify-center"
            >
              Schedule a Demo
            </button>
          </div>
