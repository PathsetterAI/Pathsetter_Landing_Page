          ...
          <div className="w-full max-w-[420px] flex flex-col gap-6 relative z-10 py-4">
            ...
            <div className="flex flex-col gap-3">
              {[
                ...
                <div key={idx} className="bg-primary-bg border border-border rounded-lg p-3 flex items-center justify-between text-left shadow-sm">
                  ...
                  <span className="text-[0.55rem] font-mono px-2 py-0.5 rounded bg-black/5 border border-border text-secondary-mid shrink-0">
                    {node.badge}
                  </span>
                </div>
              ))}
