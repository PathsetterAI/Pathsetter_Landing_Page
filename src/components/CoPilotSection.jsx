        ...
        <div className="flex flex-col lg:flex-row lg:items-center gap-12 lg:gap-16 w-full">
          ...
          <div className="flex-1 flex flex-col min-w-[300px] bg-white h-full">
            ...
            <div className="h-[52px] border-b border-gray-200/80 flex items-center justify-between px-5 bg-white shrink-0">
              <div>
                <div className="text-[13px] font-semibold text-gray-900 leading-tight">Site Alpha</div>
                  ...
                  <div className="flex-1">
                    <div className="text-[13.5px] text-gray-800 leading-[1.6]">
                      ...
                      <div className="flex gap-2">
                        <button 
                          className={`flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-[13px] font-medium transition-all ${
                            step >= 6 
