    ...
    <div className="bg-primary-bg min-h-screen w-full text-secondary-light font-primary selection:bg-accent/30">
      ...
      <section className="mt-20 pt-20 pb-12 px-4 sm:px-8 relative overflow-hidden">
        ...
        <div 
          ...
          style={{
            background: 'radial-gradient(circle at center, rgba(0, 107, 84, 0.05), transparent 70%)'
          }}
        />
        ...
        <div className="max-w-4xl mx-auto relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight text-secondary-light mb-8 font-accent">
      ...
      <section className="py-12 px-4 sm:px-8 bg-primary-bg relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
             ...
             whileInView={{ opacity: 1, y: 0 }}
             viewport={{ once: true }}
             className="prose prose-lg max-w-none text-secondary-mid mb-16"
          >
             <h2 className="text-2xl sm:text-3xl font-bold text-secondary-light mb-6 font-accent">The Anatomy of Decision Latency</h2>
             <p className="mb-4 text-secondary-mid text-lg leading-loose">
          ...
          >
            <div className="w-full bg-primary-light border border-border rounded-2xl p-4 sm:p-8 flex items-center justify-center shadow-md backdrop-blur-sm">
          ...
          <motion.div
             ...
             className="mb-20"
          >
             <h2 className="text-2xl sm:text-3xl font-bold text-secondary-light mb-10 font-accent text-center">Root Causes of Stalled Decisions</h2>
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-primary-light border border-border p-8 rounded-2xl hover:border-accent hover:shadow-[0_15px_30px_rgba(37,28,20,0.02)] transition-all duration-300">
                   <div className="w-12 h-12 bg-accent-light border border-accent/20 text-accent flex items-center justify-center rounded-xl mb-6 shadow-sm">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                   </div>
                   <h3 className="text-xl font-bold text-secondary-light mb-3">Approval Architecture Delays</h3>
                ...
                <div className="bg-primary-light border border-border p-8 rounded-2xl hover:border-accent hover:shadow-[0_15px_30px_rgba(37,28,20,0.02)] transition-all duration-300">
                   ...
                   <h3 className="text-xl font-bold text-secondary-light mb-3">Fragmented Data</h3>
                ...
                <div className="bg-primary-light border border-border p-8 rounded-2xl hover:border-accent hover:shadow-[0_15px_30px_rgba(37,28,20,0.02)] transition-all duration-300">
                   ...
                   <h3 className="text-xl font-bold text-secondary-light mb-3">Slow Communication</h3>
          ...
          <motion.div
             ...
             whileInView={{ opacity: 1, y: 0 }}
             viewport={{ once: true }}
             className="mb-16 bg-primary-light border border-border p-8 sm:p-10 rounded-[2rem]"
          >
             <h2 className="text-2xl sm:text-3xl font-bold text-secondary-light mb-10 font-accent">The 3-Part Solution Structure</h2>
             <div className="space-y-10">
                <div className="flex gap-6 sm:gap-8 items-start relative pb-10 border-b border-border last:border-0 last:pb-0">
                   <div className="text-5xl font-bold text-accent/40 font-accent w-16 text-center select-none">01</div>
                   <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary-light mb-3">Redesign Approval Workflows</h3>
                ...
                <div className="flex gap-6 sm:gap-8 items-start relative pb-10 border-b border-border last:border-0 last:pb-0">
                   <div className="text-5xl font-bold text-accent/40 font-accent w-16 text-center select-none">02</div>
                   <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary-light mb-3">Use AI for Real-Time Data</h3>
                ...
                <div className="flex gap-6 sm:gap-8 items-start relative pb-10 border-b border-border last:border-0 last:pb-0">
                   <div className="text-5xl font-bold text-accent/40 font-accent w-16 text-center select-none">03</div>
                   <div className="flex-1">
                      <h3 className="text-xl sm:text-2xl font-bold text-secondary-light mb-3">Improve Reporting Culture</h3>
          ...
          >
             <h2 className="text-3xl font-bold text-secondary-light mb-6 font-accent">Faster Decisions = <span className="text-accent border-b border-accent/30 pb-2">Competitive Advantage</span></h2>
